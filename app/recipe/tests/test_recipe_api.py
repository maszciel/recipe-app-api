...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'http://example1.com/recipe2.pdf',
    ...
    def test_deleting_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user1@example.com', password='test1234')
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Vegan Thai Curry')
        r2 = create_recipe(user=self.user, title='Pasta Alfredo')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Vegetarian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Chicken fillet')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Shoyu Ramen')
        in1 = Ingredient.objects.create(user=self.user, name='Tuna')
        in2 = Ingredient.objects.create(user=self.user, name='Udon')
